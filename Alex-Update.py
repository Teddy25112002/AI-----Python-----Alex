...
def send_email(text):
    ...
    if 'nghĩa' in recipient: # 'nghĩa' ở đây là keywords để máy tiếp tục gửi email cho bạn. Bạn có thể thay cái keywords này
        ...
        mail.ehlo()
        mail.starttls()
        mail.login('lephuocnghia2511@gmail.com', 'nghialephuoc2511') 
        mail.sendmail('lephuocnghia2511@gmail.com', 
                      'phuocnghia9a14@gmail.com', content.encode('utf-8')) 
        mail.close()
...
def introduce():
    speak("Xin chào bạn. Rất hân hạnh được phục vụ bạn. Tôi là Alex. Tôi là trợ lý ảo được tạo ra dựa trên ngôn ngữ lập trình Python kết hợp với AI. Tôi sinh ra vào ngày 4/10/2020 và được sáng lập bởi Lê Phước Nghĩa. Hiện tại bạn đang sử dụng phiên bản Alex 2.0 (cập nhật lần gần nhất ngày 9/10/2020) và cũng đang là phiên bản mới nhất.")
